            ...
            DataTable(
              ...
              rows: [
                DataRow(cells: [
                  DataCell(Text('Adamawa')),
                  DataCell(Text('15th September')),
                  DataCell(Text('4th December')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Yobe')),
                  DataCell(Text('28th October')),
                  DataCell(Text('8th December')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Borno')),
                ...
                DataRow(cells: [
                  DataCell(Text('Plateau')),
                  DataCell(Text('21st October')),
                  DataCell(Text('30th November')),
                ]),
                
                DataRow(cells: [
                  DataCell(Text('Lagos')),
                  DataCell(Text('Early July')),
                  DataCell(Text('Mid July')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Ogun')),
                ...
                DataRow(cells: [
                  DataCell(Text('Ondo')),
                  DataCell(Text('5th Septemebr')),
                  DataCell(Text('4th November')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Ekiti')),
                  DataCell(Text('10th August')),
                ...
                DataRow(cells: [
                  DataCell(Text('Akwa Ibom')),
                  DataCell(Text('4th Setember')),
                  DataCell(Text('13th September')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Delta')),
                  DataCell(Text('######')),
                ...
                DataRow(cells: [
                  DataCell(Text('Abia')),
                  DataCell(Text('5th October')),
                  DataCell(Text('20th November')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Taraba')),
                  DataCell(Text('######')),
                  DataCell(Text('18th November')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Nassarawa')),
                  DataCell(Text('2nd-4th September')),
                  DataCell(Text('2nd-5th December')),
                ]),
