...
class cashew extends StatefulWidget {
  @override
  _cashew createState() => _cashew();
}

class _cashew extends State<cashew> {
  @override
            ...
            DataTable(
              ...
              rows: [
                ...
                DataRow(cells: [
                  ...
                  DataCell(Text('2nd to 7th April')),
                  DataCell(Text('20th -25th April')),
                ]),
                DataRow(cells: [
                  DataCell(Text('Kano')),
                  DataCell(Text(' ')),
...
class cashew2 extends StatefulWidget {
  @override
  _cashew2 createState() => _cashew2();
}

class _cashew2 extends State<cashew2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
...
class cashew8 extends StatefulWidget {
  @override
  _cashew8 createState() => _cashew8();
}

class _cashew8 extends State<cashew8> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
...
class cashew3 extends StatefulWidget {
  @override
  _cashew3 createState() => _cashew3();
}

class _cashew3 extends State<cashew3> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
...
//weeding
class cashew4 extends StatefulWidget {
  @override
  _cashew4 createState() => _cashew4();
}

class _cashew4 extends State<cashew4> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
...
//post emergence
class cashew5 extends StatefulWidget {
  @override
  _cashew5 createState() => _cashew5();
}

class _cashew5 extends State<cashew5> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
...
//2nd fertilizer
class cashew6 extends StatefulWidget {
  @override
  _cashew6 createState() => _cashew6();
}

class _cashew6 extends State<cashew6> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
...
//harvesting
class cashew7 extends StatefulWidget {
  @override
  _cashew7 createState() => _cashew7();
}

class _cashew7 extends State<cashew7> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
